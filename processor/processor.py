...
class Processor(IO):
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('-c', '--config', default='config/st_gcn/ntu-xsub/test.yaml', help='path to the configuration file')
        ...
        parser.add_argument('--device', type=int, default=3, nargs='+', help='the indexes of GPUs for training or testing')
        ...
        ##20220429服务器58报错ValueError: signal number 32 out of range=================================================
        ...
        #org parser.add_argument('--batch_size', type=int, default=256, help='training batch size')
        #org parser.add_argument('--test_batch_size', type=int, default=256, help='test batch size')
